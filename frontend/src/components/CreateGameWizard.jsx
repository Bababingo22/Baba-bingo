...
export default function CreateGameWizard({ onCreated }) {
  ...
  return (
    // This component no longer needs margin props as it's handled by App.jsx
      ...
      <form onSubmit={handleSubmit} className="max-w-6xl mx-auto text-white">
        ...
        <div className="bg-[#1e2b3a] p-4 rounded-lg">
          <div className="flex justify-between items-center mb-4">
            ...
            {/* The page turn controls have been removed from here */}
          ...
          {/* This is the new, simplified grid that shows all 200 numbers */}
