...
const NumberGrid = ({ calledNumbers }) => {
  ...
  return (
    <div className="bg-[#1e2b3a] p-4 rounded-lg flex-1">
      {/* A simple flexbox layout for the columns */}
      <div className="flex justify-around h-full">
        {headers.map((letter, colIndex) => (
          <div key={letter} className="flex flex-col items-center gap-1 w-1/5">
            {/* The B-I-N-G-O Letter */}
            <div className="w-10 h-10 flex items-center justify-center text-2xl font-bold">{letter}</div>
            {/* The 15 numbers in that column */}
