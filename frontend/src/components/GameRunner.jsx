...
const getLetterColorClass = (letter) => { /* ... (This is correct) ... */ };
...
export default function GameRunner({ game, token, user, callSpeed, audioLanguage, onNav }) {
  ...
  // --- THIS IS THE ROBUST SPEECH AND WEBSOCKET LOGIC ---
  useEffect(() => {
    ...
    // This is a standard workaround for a browser bug where speech can fail on the first try.
    const warmUpSpeech = () => {
